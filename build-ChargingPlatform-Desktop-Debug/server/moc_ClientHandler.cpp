...
#include <memory>
#include "../../code/server/network/ClientHandler.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ClientHandler_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(57, 14) // "onProgressTick"

    },
    "ClientHandler\0finished\0\0start\0onReadyRead\0"
    "onDisconnected\0onProgressTick"
};
...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientHandler::finished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ClientHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_ClientHandler.offsetsAndSize,
    qt_meta_data_ClientHandler,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ClientHandler_t
, QtPrivate::TypeAndForceComplete<ClientHandler, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
