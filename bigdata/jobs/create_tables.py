...
def create(s,c,a):
 ...
 names={'dwd_station':'dwd/station','dwd_weather':'dwd/weather','dwd_session':'dwd/session','dwd_snapshot':'dwd/snapshot','dwd_bms':'dwd/bms','dws_station_15m_load':'dws/station_15m_load','dws_station_hourly_load':'dws/station_hourly_load','dws_station_daily_operation':'dws/station_daily_operation','dws_district_hourly':'dws/district_hourly','dws_user_slot_profile':'dws/user_slot_profile','ads_load_forecast':'ads/load_forecast','ads_data_quality_report':'ads/data_quality_report'}
